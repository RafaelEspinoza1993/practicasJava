public class PrimitivosEnteros {
    public static void main(String[] args) {
        ...
        System.out.println("tipo byte corresponde en bite a " + Short.SIZE);
        ...
        System.out.println("tipo byte corresponde en bite a " + Integer.SIZE);
        ...
        System.out.println("tipo byte corresponde en bite a " + Long.SIZE);
